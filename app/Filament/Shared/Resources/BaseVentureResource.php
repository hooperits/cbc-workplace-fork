          ...
          Forms\Components\Section::make()
              ...
              ->schema([
                ...
                Forms\Components\TextInput::make('url')
                    ->label(__('URL'))
                    ->maxLength(255)
                    ->helperText(__('Incluyendo http:// o https://')),
                Forms\Components\TagsInput::make('tags')
                    ->label(__('models/venture.fields.tags'))
                    ->helperText(__('Cada etiqueta representa un sinomino de su emprendimiento, por ej: la etiqueta bienestar puede ser un sinonimo de la palabra salud. Separe lo con coma.')),
