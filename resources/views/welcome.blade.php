      ...
      <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
        ...
        <header class="flex flex-col">
          ...
          <nav class="flex flex-1 justify-end">
            ...
            @else
            <a href="{{ route('filament.member.auth.login') }}" class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
              {{ __("Acceder") }}
            </a>

            @if (Route::has('filament.member.auth.register'))
            <a href="{{ route('filament.member.auth.register') }}" class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
              {{ __("Registrar") }}
            </a>
            @endif
            @endauth
          ...
          @endif
          <div class="flex lg:justify-center m-8">
        ...
        <main class="mt-6">
          <div class="grid gap-6 lg:grid-cols-1 lg:gap-8">
            ...
            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
              ...
              <a href="{{ route('venture-home') }}">
                @php
                $text = \App\Models\Text::getText('welcome-intro');
                @endphp
                <div class="pt-3 sm:pt-5">
                  <h2 class="text-xl font-semibold text-black dark:text-white">{!! str( $text[0] ?? "")->sanitizeHtml() !!}</h2>
                  {!! str( $text[1] ?? "")->sanitizeHtml() !!}
                </div>
              </a>
            </div>
            ...
            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
              ...
              <div class="pt-3 sm:pt-5">
                @php
                $text = \App\Models\Text::getText('welcome-faq');
                @endphp
                <h2 class="text-xl font-semibold text-black dark:text-white">{!! str( $text[0] ?? "")->sanitizeHtml() !!}</h2>

                <div class="overflow-auto max-h-64 pt-6">
                  {!! str( $text[1] ?? "")->sanitizeHtml() !!}
                </div>
              </div>
            </div>
